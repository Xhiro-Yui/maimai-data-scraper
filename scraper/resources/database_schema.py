...
PLAY_DATA_TABLE = Table(
    ...
    columns=[
        ...
        Column("fast", "INTEGER"),
        Column("late", "INTEGER"),
        Column("tap_critical", "INTEGER"),
        Column("tap_perfect", "INTEGER"),
        Column("tap_great", "INTEGER"),
        Column("tap_good", "INTEGER"),
        Column("tap_miss", "INTEGER"),
        Column("hold_critical", "INTEGER"),
        Column("hold_perfect", "INTEGER"),
        Column("hold_great", "INTEGER"),
        Column("hold_good", "INTEGER"),
        Column("hold_miss", "INTEGER"),
        Column("slide_critical", "INTEGER"),
        Column("slide_perfect", "INTEGER"),
        Column("slide_great", "INTEGER"),
        Column("slide_good", "INTEGER"),
        Column("slide_miss", "INTEGER"),
        Column("touch_critical", "INTEGER"),
        Column("touch_perfect", "INTEGER"),
        Column("touch_great", "INTEGER"),
        Column("touch_good", "INTEGER"),
        Column("touch_miss", "INTEGER"),
        Column("break_critical", "INTEGER"),
        Column("break_perfect", "INTEGER"),
        Column("break_great", "INTEGER"),
        Column("break_good", "INTEGER"),
        Column("break_miss", "INTEGER"),
        Column("combo", "INTEGER"),
        Column("max_combo", "INTEGER"),
        Column("sync", "INTEGER"),
        Column("max_sync", "INTEGER"),
        Column("detailed", "BOOLEAN"),
        Column("play_data_version", "INTEGER")  # Internal scraper use to handle website changes
    ],
    indexes=[
...
METADATA_TABLE = Table(
    ...
    columns=[
        ...
        Column("database_version", "INTEGER", nullable=False),
        Column("play_data_version", "INTEGER", nullable=False),
    ]
)
