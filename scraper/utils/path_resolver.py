...
def resolve_app_file_path(filename: str, data_dir_name: str = "application") -> str:
    """
    ...
    Args:
        ...
        data_dir_name (str): The name of the directory where application data files
    ...
    if getattr(sys, 'frozen', False):
        ...
        app_folder = os.path.join(base_path, data_dir_name)
    else:
        ...
        app_folder = os.path.abspath(os.path.join(project_root, data_dir_name))
